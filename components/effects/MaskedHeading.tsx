  ...
  return (
    <div ref={ref} className={`mh-wrap ${active ? 'is-active' : ''} ${className}`} style={style}>
      ...
      <style jsx>{`
        ...
        .mh-media-text { display:block; width:calc(100% * var(--mh-fill-scale)); height:calc(100% * var(--mh-fill-scale)); transform:translate(calc((100% - 100% * var(--mh-fill-scale)) / 2),calc((100% - 100% * var(--mh-fill-scale)) / 2)); background-position:center; background-size:cover; background-repeat:no-repeat; background-color:#4dff82; background-clip:text; -webkit-background-clip:text; color:transparent; -webkit-text-fill-color:transparent; text-shadow:0 0 24px rgba(51,255,102,.16); }
