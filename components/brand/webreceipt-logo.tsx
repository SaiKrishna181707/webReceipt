 ...
 * The entire mark is rendered in the DOM/SVG tree — no image asset is used.
 */
export function WebReceiptLogo({ size = 54, flicker = true, className = '' }: LogoProps) {
  ...
  return (
    ...
    >
      ...
      >
        <style>{`
          .wr-tile { fill: rgba(10, 54, 24, .94); stroke: rgba(109, 235, 132, .9); stroke-width: 2.5; }
          .wr-tile-glow { fill: none; stroke: rgba(51,255,102,.5); stroke-width: 5; opacity: .28; }
          .wr-symbol { font-family: Georgia, 'Times New Roman', serif; font-weight: 700; fill: #dff7e4; }
          .wr-word { font-family: Georgia, 'Times New Roman', serif; font-size: 70px; font-weight: 600; fill: #dff7e4; letter-spacing: -3px; }
          .wr-atomic { font-family: 'JetBrains Mono', ui-monospace, monospace; font-size: 13px; fill: rgba(190,244,203,.9); }
          ...
          @keyframes wrGlow { 0%,100% { opacity:.18; } 50% { opacity:.62; } }
