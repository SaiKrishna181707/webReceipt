export function renderProductFixture(version = 'v1') {
  ...
  // public page is owned by WebReceipt and exists only to reproduce semantic
  // drift safely; no real retailer is claimed to have changed its website.
  ...
  return `<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Example Store Product — WebReceipt Controlled Fixture</title>
<style>
...
<body>
  <div class="wrap"><div class="grid">
    <section class="hero" data-testid="offer-panel" data-fixture-kind="product">
      ...
      <div class="meta">
        <span>Brand: <strong data-testid="product-brand">Example Store</strong></span>
        <span>Model: <strong data-testid="product-model">Studio Wireless</strong></span>
        <span>SKU: <strong data-testid="product-sku">WR-STUDIO-01</strong></span>
        <span>Seller: <strong data-testid="seller-name">Example Store</strong></span>
      </div>
      ...
      <div class="notice">Owned WebReceipt test fixture for deterministic semantic-drift reproduction. No account, personal data, payment, or purchase is required.</div>
    </section>
    ...
    <section class="box" data-testid="checkout-panel" hidden>
      ...
      <div class="terms">
        ...
        <p id="payment-timing"><strong>Payment:</strong> No payment required in this test fixture</p>
        <p id="inclusions"><strong>Includes:</strong> Wireless Studio Headphones</p>
        <p data-testid="warranty"><strong>Warranty:</strong> Example manufacturer policy applies</p>
      </div>
